        ...
        <div class="table_section_main">
            ...
            <b-row>
                <b-col md="12" class="text-right mb-3">
                    <b-button class="theme-color1" @click="createposition">Assign Workers</b-button>
                </b-col>
            </b-row>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Plumber</td>
                            <td class="lightcolr">
                                <p><a href="mailto:wade.warren@example.com">wade.warren@example.com</a></p>
                                <p><a href="tel:(219) 555-0114">(219) 555-0114</a></p>
                            </td>
                            <td>
                                <p>Sacrumento</p>
                            </td>
                            ...
                            <td>
                                <p class="staus1">Awaiting Review</p>
                            </td>
                            <td><p class="staus2">Had conversation</p></td>
                        </tr>
                        <tr>
                            <td>
                                <b-icon icon="three-dots-vertical" class="editcl" scale="1" @click="editrowfunc"></b-icon><b-form-checkbox value="2"></b-form-checkbox>
